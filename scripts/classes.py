"""Labels, filters, and palettes from the original DeWorldSG renderer.

Adapted from ``FROSS/Merging/Visualization/classes.py`` (Apache-2.0).  The
values are intentionally unchanged so the replay keeps the author's style.
"""
